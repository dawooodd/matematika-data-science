...
Original file is located at
    https://colab.research.google.com/drive/1FSCzDEM4cuCmmJWHsR8XAXiRtWPQjGbl
...
def generate_df_ab_test(n_days=20):
  ...
  # Memisahkan ID untuk masing-masing grup
...
def degrees_of_freedom(origin_metrics, varian_metrics):
  ...
  # Varians dibagi N untuk masing-masing grup
  v1 = (s1**2) / n1
  v2 = (s2**2) / n2

  # Menghitung pembilang dan penyebut dari rumus Satterthwaite
  numerator = (v1 + v2)**2
