# -*- coding: utf-8 -*-
"""Salinan dari soal-3-software-dev-ab.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16_aL1KM57kSYR4ro01GRAsPBsqBGpfGo
...
def generate_proportion_metrics(data):
  ...
  metrics = metrics_estimation(n, x, p)
  ## AKHIRI KODE DI SINI
...
def z_statistic_diff_proportions(origin_metrics, varian_metrics):
  ...
  numerator = p1 - p2
  denominator = np.sqrt(p_hat * (1 - p_hat) * ((1 / n1) + (1 / n2)))
